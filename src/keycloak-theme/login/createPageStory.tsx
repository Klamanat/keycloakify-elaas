    ...
    function PageStory(params: { kcContext?: DeepPartial<Extract<KcContext, { pageId: PageId }>>; }) {
        ...
        return (
            <>
                ...
                <link rel="stylesheet" type="text/css" href={`${import.meta.env.BASE_URL}css/uno.css`} />
                <link rel="stylesheet" type="text/css" href={`${import.meta.env.BASE_URL}css/style.css`} />
